...
describe SSHScan::Constants do
  ...
  it "should have the right values for DEFAULT_KEY_INIT" do
    expect(SSHScan::Constants::DEFAULT_KEY_INIT).to be_kind_of(SSHScan::KeyExchangeInit)
    expect(SSHScan::Constants::DEFAULT_KEY_INIT.to_binary_s).to eql(SSHScan::Constants::DEFAULT_KEY_INIT_RAW)
  end
