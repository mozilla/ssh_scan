...
describe SSHScan::KeyExchangeInit do
  context "when parsing raw client SSH Key Exchange Initialization messages on the wire" do
    it "should properly parse a raw client KeyExchangeInit from the wire" do
      ...
      expect(kex_init.to_binary_s).to eql(raw_kex_client_init)
  ...
  context "when parsing raw server SSH Key Exchange Initialization messages on the wire" do
    ...
    it "should properly parse a raw server KeyExchangeInit from the wire" do
      ...
      expect(kex_init.to_binary_s).to eql(raw_server_kex_init)
      ...
      expect(kex_init.compression_algorithms_server_to_client).to eql(["none", "zlib@openssh.com"])
  ...
  context "when building a client SSH Key Exchange Initialization message from scratch" do
    before :each do
      @raw_kex_client_init = ("000001640414e33f813f8cdcc6b00a3d852ec1aea4980000001a6" +
                              "469666669652d68656c6c6d616e2d67726f7570312d7368613100" +
                              "00000f7373682d6473732c7373682d72736100000057616573313" +
    ...
    it "should allow me to set server_host_key_algorithms" do
      ...
      expect(kex_init.server_host_key_algorithms).to eql(["ssh-dss", "ssh-abcd"])
    ...
    it "should allow me to set encryption_algorithms_client_to_server" do
      ...
      expect(kex_init.encryption_algorithms_client_to_server_length).to eql(43)
    ...
    it "should allow me to set encryption_algorithms_server_to_client" do
      ...
      expect(kex_init.encryption_algorithms_server_to_client_length).to eql(43)
      expect(kex_init.packet_length).to eql(312)
    end
    ...
    it "should allow me to set compression_algorithms_client_to_server" do
      ...
      expect(kex_init.compression_algorithms_client_to_server_length).to eql(11)
    ...
    it "should allow me to set compression_algorithms_server_to_client" do
      ...
      expect(kex_init.compression_algorithms_server_to_client_length).to eql(11)
      expect(kex_init.packet_length).to eql(363)
    end
  ...
  context "when building a client SSH Key Exchange Initialization message from a hash" do
    before :each do
      @raw_kex_client_init = ("000001640414e33f813f8cdcc6b00a3d852ec1aea4980000001a6" +
                              "469666669652d68656c6c6d616e2d67726f7570312d7368613100" +
                              "00000f7373682d6473732c7373682d72736100000057616573313" +
                              ...
                              "726970656d64313630000000046e6f6e65000000046e6f6e65000" +
                              "000000000000000000000006e05b3b4").unhexify
      @comparitive_key_client_init = SSHScan::KeyExchangeInit.read(@raw_kex_client_init)
    end
    ...
    it "should allow me to create a client key_init from a hash" do
      ...
      expect(kex_init.key_algorithms).to eql(@comparitive_key_client_init.key_algorithms)
      expect(kex_init.server_host_key_algorithms).to eql(@comparitive_key_client_init.server_host_key_algorithms)
      expect(kex_init.encryption_algorithms_client_to_server).to eql(@comparitive_key_client_init.encryption_algorithms_client_to_server)
      expect(kex_init.encryption_algorithms_server_to_client).to eql(@comparitive_key_client_init.encryption_algorithms_server_to_client)
      expect(kex_init.mac_algorithms_client_to_server).to eql(@comparitive_key_client_init.mac_algorithms_client_to_server)
      expect(kex_init.mac_algorithms_server_to_client).to eql(@comparitive_key_client_init.mac_algorithms_server_to_client)
      expect(kex_init.compression_algorithms_client_to_server).to eql(@comparitive_key_client_init.compression_algorithms_client_to_server)
      expect(kex_init.compression_algorithms_server_to_client).to eql(@comparitive_key_client_init.compression_algorithms_server_to_client)
      expect(kex_init.languages_client_to_server).to eql(@comparitive_key_client_init.languages_client_to_server)
      expect(kex_init.languages_server_to_client).to eql(@comparitive_key_client_init.languages_server_to_client)
      expect(kex_init.message_code).to eql(@comparitive_key_client_init.message_code)
      expect(kex_init.padding_length).to eql(@comparitive_key_client_init.padding_length)
      expect(kex_init.cookie).to eql(@comparitive_key_client_init.cookie)
      expect(kex_init.kex_first_packet_follows).to eql(@comparitive_key_client_init.kex_first_packet_follows)
      ...
      expect(kex_init.packet_length).to eql(@comparitive_key_client_init.packet_length)

      # Verify we can build the exact same binary string we were parsing before
      expect(kex_init.to_binary_s.hexify).to eql(@comparitive_key_client_init.to_binary_s.hexify)
      expect(kex_init.to_binary_s.hexify).to eql(@raw_kex_client_init.hexify)
    end
